...
from tools.utils_v0826_srrg import setup_arguments, setup_seed
from models.align_v0702_v0904_srrg import *
...
def train():
    ...
    if args['task'] == 'report-generation-llm':
        model = ReportGenerationLLM(args, logger)
    elif args['task'] == 'report-generation-lora':
        assert args['llm_use_lora'] == True
        model = ReportGenerationLoRA(args, logger)
    else:
