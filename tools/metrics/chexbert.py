...
class F1CheXbertMetrics(NaturalLanguage):
    ...
    def compute(self):
        ...
        scores = {
            "chexbert_5_micro_p": chexbert_5_micro_f1['precision'],
            "chexbert_5_micro_r": chexbert_5_micro_f1['recall'],
            "chexbert_5_micro_f1": chexbert_5_micro_f1["f1-score"],
            "chexbert_5_macro_p": chexbert_5_macro_f1['precision'],
            "chexbert_5_macro_r": chexbert_5_macro_f1['recall'],
