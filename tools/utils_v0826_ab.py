...
def setup_arguments():
    ...
    parse.add_argument('--task', type=str, default='report-generation',
                       choices=['pretrain', 'report-generation', 'report-generation-llm'],
    ...
    parse.add_argument('--phase', type=str, default='finetune',
    ...
    parse.add_argument('--ann_path', type=str, help='the local path of radiology reports',
                       ...
                       # default='script/six_work_mimic_cxr_annotation_similar_case_v0702_gaze.json',
                       )
    ...
    parse.add_argument('--test_ckpt_path', type=str, help='the path of the ckpt for inference',
                       default='/script/results/mimic_cxr/pretrain/finetune_v0702-v0826-pretrain_2025_08_27_15/checkpoint/best_model.pt'
                       )
    parse.add_argument('--version', type=str, default='CoGaze', help='the name of experiment')
    ...
    parse.add_argument('--topk_ratio', type=float, help="the ratio of mask for eye-heatmap",
                       default=0.25)
    parse.add_argument('--has_disease_loss', type=str2bool, help="whether use disease_loss", default='yes')

    parse.add_argument('--has_context', type=str2bool, help="whether use clinical context", default='yes')
    parse.add_argument('--lambda', type=float, help="the balanced score between i2t and t2i",
                       default=0.8)
