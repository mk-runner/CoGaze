...
def setup_arguments():
    ...
    parse.add_argument('--task', type=str, default='report-generation-lora',
                       choices=['report-generation-llm', 'report-generation-lora'],
    ...
    parse.add_argument('--data_name', type=str, choices=['srrg'], default='srrg',
                       help='the name of the dataset')
    parse.add_argument('--ann_path', type=str, help='the local path of radiology reports',
                       )
    parse.add_argument('--mimic_dir', type=str, help='the directory of MIMIC-CXR',
                       default='/MIMIC-CXR/'
                       )
    parse.add_argument('--chexpert_dir', type=str, help='the directory of CheXpert-plus',
                       default='/MIMIC-CXR/'
                       )
    parse.add_argument('--view_position_path', type=str, help='the local path of view positions dict',
                       default='/MIMIC-CXR/view-positions-dict.json'
                       )
